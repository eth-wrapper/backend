...
router.post('/set-ethereum-deposit', requireParam('swap:Swap',"address:string","sig:string", "txHash:string"), SwapController.setEthereumDeposit);
router.post('/info', requireParam("swap:Swap"), SwapController.info);
